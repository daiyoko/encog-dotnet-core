...
namespace Encog.ML.Data.Specific
{
    ...
    /// datasets.
    /// </summary>
    public class MySQLMLDataSet : BasicMLDataSet
    {
        /// <summary>
        ...
        public MySQLMLDataSet(String sql, int inputSize,
                            int idealSize, String connectString)
        {
            IDataSetCODEC codec = new MySQLCODEC(sql, inputSize, idealSize, connectString);
